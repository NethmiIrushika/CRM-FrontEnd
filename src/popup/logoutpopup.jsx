        ...
        <div className='fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center'>
          <div className="bg-white p-6 rounded shadow-md">
            ...
            <div className="flex justify-between">
              <button onClick={onConfirm} className="inline-block w-1/2 py-2 px-4 bg-yellow-400 text-white rounded-l-md hover:bg-yellow-400 focus:outline-none mr-1">Yes </button>
              <button onClick={onClose} className="inline-block w-1/2 py-2 px-4 bg-yellow-400 text-white rounded-r-md hover:bg-yellow-400 focus:outline-none bg-yellow-400"> No </button>
            </div>
          </div>
        </div>
      )}
