          ...
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                <div className="flex items-center  w-40 h-10">
                  ...
                  <span className="ms-3 text-black justify-center">Dashboard</span>
                </div>
              </button>
            </li>
            <li>
              ...
              >
                ...
                <span className="ms-3 text-black justify-center ">CR View</span>
                </div>
              </button>
            </li>
            <li>
              ...
              >
                ...
                <span className="ms-3 text-black justify-center">CR Proto Type </span>
                </div>
              </button>
            </li>
            ...
            <li>
              ...
              >
                ...
                >
                  <path
                    d="M10 4v12m-4-4h8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span className="ms-3 text-black justify-center">Create New CR</span>
                </div>
              </button>
            </li>
            <li>
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3 text-black justify-center">Add User</span>
                </div>
              </button>
            </li>
            <li>
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3 text-black justify-center">Profile</span>
                </div>
              </button>
            </li>
            <li>
              ...
              >
                ...
                <span className="ms-3 text-black justify-center ">Log Out</span>
                </div>
              </button>
            </li>
          </ul>
